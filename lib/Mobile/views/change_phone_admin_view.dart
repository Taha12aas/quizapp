...
class ChangePhoneAdminView extends StatefulWidget {
  const ChangePhoneAdminView({super.key});
  static String id = 'ChangePhoneAdmin';

  @override
  State<ChangePhoneAdminView> createState() => _ChangePhoneAdminViewState();
}

class _ChangePhoneAdminViewState extends State<ChangePhoneAdminView> {
                    ...
                    listener: (context, state) {
                      ...
                      if (state is AdminFaliureStatus) {
                        ScaffoldMessenger.of(context).showSnackBar(showSnackBar(
                            context, 'حدث خطأ اثناء تغيير الرقم اعد المحاولة'));
                      }
                    },
